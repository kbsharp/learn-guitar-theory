...
// "practice" gives a concrete physical instruction the user can do right now.
export const scaleExplanations: Record<Quality, ScaleExplanation> = {
	[Quality.Ionian]: {
		...
		practice:
			'Hold a C major chord. Run the C major scale up and down. Try ending phrases on C, E, or G (the chord tones) — those are home. Land elsewhere and you create momentum that wants to resolve back.'
	},
	[Quality.Dorian]: {
		...
		practice:
			'Loop an Am chord. Play A minor pentatonic, then add F# (fret 4, D string) on a strong beat. That one extra note is the Dorian colour. Remove it and you are back to plain minor.'
	},
	[Quality.Phrygian]: {
		...
		practice:
			'Hold an Em chord. Slide from F (fret 1, low E string) down to E. That semitone slide is the Phrygian signature — Spanish guitar in one move. Repeat it over the static minor and let it sit.'
	},
	[Quality.Lydian]: {
		...
		practice:
			'Hold a Cmaj7 chord. Play C, D, E, then F# (fret 4, D string) instead of F natural, then G. That one raised note transforms the major sound into a cinematic float.'
	},
	[Quality.Mixolydian]: {
		...
		practice:
			'Loop a G7 chord. Play G major scale but flatten the F# to F (fret 1, high E string instead of fret 2). Land on that F deliberately — that flat 7 is the entire Mixolydian sound.'
	},
	[Quality.Aeolian]: {
		...
		practice:
			'Loop an Am chord. Play A natural minor and end phrases on the b6 (F) and b3 (C). Those two notes are what give Aeolian its melancholy — Dorian would lift the F up, but here you sit in the weight.'
	},
	[Quality.Locrian]: {
		...
		practice:
			'Hold a Bm7♭5 chord. Play B Locrian — but do not try to land there. Let the scale flow toward E7 and then Am. Locrian is a journey through tension, not a destination.'
	},
	[Quality.MajorPentatonic]: {
		...
		next: { href: '/chord-scale', label: 'See it set to a major chord' },
		practice:
			'Pick any major chord — C, G, or D — and loop it. Play C major pentatonic anywhere on the neck. You literally cannot pick a wrong note. Target the 3rd and 5th for the most resolved phrases.'
	},
	[Quality.MinorPentatonic]: {
		...
		next: { href: '/chord-scale', label: 'See it set to a minor chord' },
		practice:
			'Loop an Am chord. Play box 1 of A minor pentatonic (frets 5–8). Bend the b3 (fret 7, G string) up a half-step and release. That bend-and-release is the most-used phrase in rock and blues — practise it slowly.'
	},
	[Quality.Blues]: {
		...
		next: { href: '/chord-scale', label: 'See it set to a minor chord' },
		practice:
			'In box 1 of A minor pentatonic, slide between fret 7 (D, the 4th) and fret 8 (D#, the b5) on the G string. That slide-and-release IS the blues. Repeat for 30 seconds over an Am chord and the sound clicks.'
	}
};
